...
use schema_registry_converter::schema_registry_common::{RegisteredSchema, SchemaType, SuppliedSchema};
...
impl PowerEvent {
    ...
    "#
     ...
     pub async fn publish_schema(sr_settings: &SrSettings, subject: String) -> Result<RegisteredSchema, SRCError> {
